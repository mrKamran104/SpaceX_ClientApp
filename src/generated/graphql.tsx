...
export type LaunchInfoQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_year' | 'launch_success' | 'details' | 'upcoming'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
...
export type LaunchesInfoQueryVariables = Exact<{
  limit: Scalars['Int'];
  sort: Scalars['String'];
...
export type LaunchesInfoQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'launch_year' | 'launch_success' | 'upcoming' | 'mission_name'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images'>
    )> }
